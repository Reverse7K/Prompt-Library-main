...
export default async function AiModelsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <p className="text-muted text-sm mb-8">เลือกดู Prompt ที่ใช้ได้กับโมเดลนี้</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {aiModels?.map((model) => (
          <Link
            ...
            className="group p-6 rounded-xl bg-surface border border-line hover:border-accent2/60 hover:shadow-[0_0_24px_rgba(255,62,200,0.2)] transition-all flex items-center gap-4"
          >
            {model.logo_url ? (
