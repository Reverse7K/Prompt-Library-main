    ...
    <div className="max-w-5xl mx-auto px-6 py-8 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 mt-4">
        ...
        <div className="lg:col-span-3">
          <div className="aspect-video rounded-xl bg-surface border border-line mb-3" />
          <div className="flex gap-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="w-20 h-20 rounded-lg bg-surface border border-line" />
            ))}
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="h-32 rounded-lg bg-surface border border-line" />
